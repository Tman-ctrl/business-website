...
// Never let stray notices/warnings leak into the JSON response body.
// (Keep error logging on for debugging, just don't print to output.)
...
// FIX: reference the constants directly instead of undefined
// $company_phone / $company_site variables, which previously
// interpolated to empty strings and threw "undefined variable"
// warnings that could corrupt the JSON response output.
$admin_body = <<<TEXT
═══════════════════════════════════════════
